...
(function ($) {
    ...
    $.fn.addTriggersToJqueryValidate = function () {
        ...
        return this.each(function () {
            ...
            if (form.data('jQueryValidateTriggersAdded')) return;else form.data('jQueryValidateTriggersAdded', true);
    ...
    $.fn.extend({
        ...
        //
        triggerElementValidationsOnFormValidation: function triggerElementValidationsOnFormValidation() {
            return this.each(function () {
        ...
        formValidation: function formValidation(fn) {
            return this.each(function () {
        ...
        formValidationSuccess: function formValidationSuccess(fn) {
            return this.each(function () {
        ...
        formValidationError: function formValidationError(fn) {
            return this.each(function () {
        ...
        formValidAndInvalid: function formValidAndInvalid(valid, invalid) {
            return this.each(function () {
                $(this).bind('formValidationSuccess', function (e, element) {
                    valid(element);
                });
        ...
        elementValidation: function elementValidation(fn) {
            return this.each(function () {
        ...
        elementValidationSuccess: function elementValidationSuccess(fn) {
            return this.each(function () {
        ...
        elementValidationError: function elementValidationError(fn) {
            return this.each(function () {
        ...
        elementValidAndInvalid: function elementValidAndInvalid(valid, invalid) {
            return this.each(function () {
                $(this).bind('elementValidationSuccess', function (e, element) {
                    valid(element);
                });
